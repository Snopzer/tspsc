...
(function ($) {
	...
	tpuuid = new Date(0000000000000).setTime(1800000); 
	// d.setTime(1800000); 
	// tpuuid = new Date(1469433907836);
	// tpuuid =  1800000;	
	// alert(tpuuid);
    ...
    function Timepicker() {
        ...
        this.regional[''] = { // Default regional settings
            hourText: 'Hours',           // Display text for hours section
            ...
            if (showHours) {
                ...
                for (row = 1; row <= rows; row++) {
                    ...
                    if (row == amFirstRow && showPeriodLabels) {
                        // html += '<th rowspan="' + amRows.toString() + '" class="periods" scope="row">' + " " + '</th>';
					}
                    // PM
                    if (row == pmFirstRow && showPeriodLabels) {
                        // html += '<th rowspan="' + pmRows.toString() + '" class="periods" scope="row">' + " " + '</th>';
					}
